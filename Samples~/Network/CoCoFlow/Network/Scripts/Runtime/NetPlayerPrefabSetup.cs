...
using CoCoFlow.Runtime.Addon.Network.Lifecycle;
using CoCoFlow.Runtime.Addon.Network.Animations;
...
namespace CoCoFlow.Runtime.Addon.Network
{
    ...
    /// <item><b>NetworkTransform</b> (Fusion) — 同步玩家 Transform，配合 NetCharacterMotor 的权威端移动</item>
    /// <item><b>CharacterController</b> (Unity) — 角色移动碰撞体，NetCharacterMotor 依赖此组件</item>
    /// <item><b>NetCharacterMotor</b> (Network) — 网络专用移动器，在 Fusion Tick 中驱动 CharacterController</item>
    ...
    /// <item><b>NetCharacter</b> (NetworkBehaviour) — 网络角色中枢，协调 NetCharacterMotor 与 NetStateSyncHandler</item>
    ...
    /// <item><b>NetAnimatorSync</b> (NetworkBehaviour) — 从 NetCharacterMotor/CharacterLifeCycle 读取状态并同步动画参数</item>
    /// </list>
    ///
    /// <para><b>创建步骤：</b></para>
    ...
    [RequireComponent(typeof(NetCharacterMotor))]
    ...
    public class NetPlayerPrefabSetup : MonoBehaviour
    {
        ...
        private void Reset()
        {
            ...
            AddIfMissing<NetCharacterMotor>();
