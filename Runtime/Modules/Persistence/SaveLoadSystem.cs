...
namespace CocoFlow.Runtime.Modules.Persistence
{
    public static class SaveLoadSystem
    {
        ...
        public static void SaveGame(int slotIndex = -1)
        {
            ...
            if (RuntimeStateManager.CurrentData == null)
            {
            ...
            try
            {
                string jsonString = JsonConvert.SerializeObject(RuntimeStateManager.CurrentData, Formatting.Indented);
        ...
        public static bool LoadGame(int slotIndex = -1)
        {
            ...
            try
            {
                ...
                RuntimeStateManager.InjectData(loadedData);
